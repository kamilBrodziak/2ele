...
CustomSelect.prototype.showSelect=function(){var a=this,b=$("body");b.on("click",".customSelect",function(b){b=$(this).find(".customSelectItemsContainer").hasClass("hide");a.hideSelect();b&&($(this).find(".customSelectItemsContainer").removeClass("hide"),$(this).find(".customSelectSelected").addClass("selectArrowActive"))});b.on("click",".customSelectItem",function(a){a=$(this).closest(".teaseProduct");var b=a.find(".customSelectSelected"),c=a.find(".teaseProductFormQuantity"),f=parseInt($(this).data("max_quantity"));
b.html($(this).html());b.data("variation_id",$(this).data("variation_id"));a.find(".teaseProductFormSubmit").removeAttr("disabled");a.find(".teaseProductPicture").attr("src",$(this).data("image_src"));99>=f&&c.attr("max",f);parseInt(c.val())>f&&c.val(f);$(this).siblings(".sameAsSelected").removeClass("sameAsSelected");$(this).addClass("sameAsSelected")})};
...
TeaseProducts.prototype.addForm=function(a,b){var c=this;$("body").on("submit","."+a,function(a){a.preventDefault();a=$(c);var d=a.data("product_id"),f=a.find(".teaseProductFormQuantity").val(),g=a.find(".customSelectSelected").data("variation_id"),h=a.closest(".teaseProduct");$.ajax({url:ajaxPaginationParams.ajaxUrl,type:"POST",data:{productID:d,quantity:f,variationID:g,action:"addProductToCart"},beforeSend:function(){h.addClass("loadingScreen")},error:function(a){console.log(a);h.removeClass("loadingScreen")},
success:function(a){h.removeClass("loadingScreen");var c=$("#"+b),d="";"false"===a?(console.log("Wyst\u0105pi\u0142 problem"),d="errorScreen"):(c.html(a),d="successScreen");h.addClass(d);window.setTimeout(function(){h.removeClass(d)},2E3)}})})};var CartWidget=function(a){this.widgetContainer=a;this.widget=null;this.cartItemClass="cartItem";this.cartItemsQuantities=this.cartItemsRemoves=null};CartWidget.prototype.withWidget=function(){this.widget&&this.widget.remove();this.widget=this.widgetContainer.find(".cartWidget");this.cartItemsRemoves=this.widget.find(".cartItemRemove");this.cartItemsQuantities=this.widget.find(".cartItemQuantity");this.addRemoveItemButton();this.addQuantityChangeInput()};CartWidget.prototype.loadWidgetAjax=function(){this.reloadWidgetAjax(data)};
CartWidget.prototype.reloadWidgetAjax=function(a){var b=this;ajaxCall(a,function(){b.widgetContainer.addClass("loadingScreen")},function(){b.widgetContainer.removeClass("loadingScreen")},function(a){b.widgetContainer.removeClass("loadingScreen");b.widgetContainer.empty().append(a);b.withWidget()})};
CartWidget.prototype.addRemoveItemButton=function(){var a=this,b=this;this.cartItemsRemoves.each(function(){$(a).on("click",function(c){c.preventDefault();c={productKey:$(a).closest("."+b.cartItemClass).data("product_key"),action:"removeProductFromCart"};b.reloadWidgetAjax(c)})})};
CartWidget.prototype.addQuantityChangeInput=function(){var a=this,b=this;this.cartItemsQuantities.each(function(){$(a).on("keyup focusout",function(c){c.preventDefault();var d=$(a);"keyup"===c.type&&13===c.keyCode&&d.blur();"focusout"===c.type&&$.when(addInputMinMaxTesting(d)).done(function(){var a={productKey:d.closest("."+b.cartItemClass).data("product_key"),quantity:d.val(),action:"changeProductQuantityInCart"};b.reloadWidgetAjax(a)})})})};var FormValidation=function(){};FormValidation.prototype.addBasicValidation=function(a,b,c,d,e,f){this.submit=f;this.validation={username:!1,email:!1,confirmEmail:!1,password:!1,confirmPassword:!1};this.submit.attr("disabled",!0);this.usernameValidation(a);this.emailValidation(b,c);this.passwordValidation(d,e)};
...
FormValidation.prototype.inputValidation=function(a,b){var c=!0,d=this,e=a.parent(),f=function(c,e,f,g){(f=void 0===f?!1:f)?d.validate(f,void 0===g?"":g,c,e):d.validate(a,b.inputName,c,e)},g=b.disallowedKeys;if(!b.allowPaste)a.on("paste",function(a){a.preventDefault()});if(g.length)a.on("keydown",function(a){for(var b=$jscomp.makeIterator(g),d=b.next();!d.done;d=b.next())if(a.key===d.value)return c=!1;c=!0});a.on("keyup",function(){if(c){var d=a.val(),g=b.testRegex;if(g&&!g.regex.test(d))f(!1,g.message);
else{var k=(g=b.testMatch)?g.matchingInput.val()===d:!0;if(k||g.isParent){var m=b.testUnique;m?(f(!1,"Sprawdzanie unikalno\u015bci..."),setTimeout(function(){ajaxCall({action:"isUserUnique",type:b.inputName,value:d},function(){return e.addClass("loadingRight")},e.removeClass("loadingRight"),function(a){e.removeClass("loadingRight");f("true"===a,"true"===a?"":m.message)})},800)):f(!0,"");g.isParent&&f(k,k?"":g.message,g.matchingInput,g.matchingInputName)}else f(!1,g.message)}}})};
FormValidation.prototype.validate=function(a,b,c,d){var e=c?"approvedInput":"wrongInput";this.validation[b]=c;this.validateForm();this.frontendNotice(a,d,e)};FormValidation.prototype.validateForm=function(){this.submit.attr("disabled",!(this.validation.username&&this.validation.email&&this.validation.confirmEmail&&this.validation.password&&this.validation.confirmPassword))};
...
LoginWidget.prototype.addRegisterAjax=function(){var a=this.registerFormInputs.username,b=this.registerFormInputs.email,c=this.registerFormInputs.password,d=this.registerForm.find(".registerFormNotices"),e=this,f={action:"userRegisterAjax"},g=function(){e.registerForm.addClass(e.loadingClass)},h=function(){e.registerForm.removeClass(e.loadingClass)},l=function(f){e.registerForm.removeClass(e.loadingClass);"success"===f?(a.val(""),b.val(""),e.registerFormInputs.confirmEmail.val(""),c.val(""),e.registerFormInputs.confirmPassword.val(""),
d.html("Rejestracja przebieg\u0142a pomy\u015blnie! Mo\u017cesz teraz zalogowa\u0107 si\u0119.")):d.html(f);$("html, body").animate({scrollTop:0},600)};this.registerForm.on("submit",function(d){d.preventDefault();f.username=a.val();f.email=b.val();f.password=c.val();ajaxCall(f,g,h,l)})};
LoginWidget.prototype.addLoginAjax=function(a){var b=this;a=void 0===a?!1:a;var c=this.loginFormInputs.username,d=this.loginFormInputs.password,e=this.loginFormInputs.remember,f=this,g=function(){f.loginForm.addClass(f.loadingClass)},h=function(){f.loginForm.removeClass(f.loadingClass)},l=function(c){f.loginForm.removeClass(f.loadingClass);"success"===c?a?location.reload():f.loadLogoutWidget():f.loginForm.find(".loginFormNotices").html(c);b.widgetContainer.animate({scrollTop:0},600)},k={action:"userLoginAjax",
signOn:!a};this.loginForm.on("submit",function(a){a.preventDefault();k.username=c.val();k.password=d.val();k.remember=e.is(":checked");ajaxCall(k,g,h,l)})};
...
CheckoutWidget.prototype.withWidget=function(){var a=this,b=this;this.widget&&this.widget.remove();this.widget=this.container.find(".checkoutWidget");this.cartLink=this.widget.find(".checkoutWidgetPreviousLink");this.stage=0;this.widget.find(".orderWidgetStage").each(function(){b.stages.push($(a))});this.previousButton=this.widget.find(".checkoutWidgetPreviousButton");this.nextButton=this.widget.find(".checkoutWidgetNextButton");this.stagesNames=["Formularz","Podsumowanie i dostawa","P\u0142atno\u015b\u0107"];
this.stagesNodes=[this.widget.find(".checkoutWidgetBilling"),this.widget.find(".checkoutWidgetSummary"),this.widget.find(".checkoutWidgetPayment")];var c=$(".checkoutWidgetLoginContainer");c.length&&(this.loginWidget=new LoginWidget(c),this.loginWidget.withWidget(!0),this.stagesNodes.unshift(this.widget.find(".loginWidget")),this.stagesNames.unshift("Logowanie"));this.changeStage();this.addPagination()};
...
!1)})};EmailFormHandler.prototype.displayMessage=function(a){var b=this.form.find("."+a);b.css("display","flex");setTimeout(function(){b.css("display","none")},2E3)};$(function(){var a=.01*window.innerHeight;document.documentElement.style.setProperty("--vh",a+"px");$(window).on("resize",function(){a=.01*window.innerHeight;document.documentElement.style.setProperty("--vh",a+"px")});var b=new MobileNav($("#shopNavWrapper"),"shopNavDisplay",$("#shopNavMobileCloseButton"));b.addCloseOnResizeEvent();b.addNavSubListExpandButton($(".shopNavListItemSubListExpandButton"),"shopNavListItemSubList","expand");b=new Search("shopSearch");b.addAjaxSearch();b.closingSearchResultEvent();
b=$("#pageContactForm");b.length&&(new EmailFormHandler(b)).submitEvent();b=$("#shopPageProductListWidget");b.length&&(new AjaxPagination(b,"shopPageProductListWidget")).addAjaxPagination();b=$(".teaseProduct");b.length&&((new TeaseProducts(b,"teaseProductAnchor")).addForm("teaseProductForm","cartButtonQuantity"),b=new CustomSelect,b.showSelect(),b.hideSelectWhenClickedOutsideSelect());b=$("#accountPageLoginWidgetContainer");b.length&&(new LoginWidget(b)).withWidget(!0);b=$("#cartPageCartWidgetContainer");
b.length&&(new OrderWidget(b)).withWidget();b=$("#cartButton");b.length&&(new OrderWidget($('<div id="#orderWidgetContainer" class="widget">'))).loadWidgetAjaxViaButton(b);b=$("#checkoutPage");b.length&&(new CheckoutWidget(b)).withWidget()});function addInputMinMaxTesting(a){var b=a.attr("min"),c=a.attr("max"),d=a.val();c&&parseInt(d)>parseInt(c)?a.val(c):b&&parseInt(d)<parseInt(b)?a.val(b):""===d&&(b?a.val(b):a.val(1))}
function ajaxCall(a,b,c,d){$.ajax({url:ajaxPaginationParams.ajaxUrl,type:"POST",data:a,beforeSend:b,error:c,success:d})};
