...
else{var h=(g=b.testMatch)?g.matchingInput.val()===d:!0;if(h||g.isParent){var m=b.testUnique;m?(f(!1,"Sprawdzanie unikalno\u015bci..."),setTimeout(function(){ajaxCall({action:"isUserUnique",type:b.inputName,value:d},function(){return e.addClass("loadingRight")},e.removeClass("loadingRight"),function(a){e.removeClass("loadingRight");f("true"===a,"true"===a?"":m.message)})},800)):f(!0,"");g.isParent&&f(h,h?"":g.message,g.matchingInput,g.matchingInputName)}else f(!1,g.message)}}})};
