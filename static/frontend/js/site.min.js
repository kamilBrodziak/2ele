...
b.length&&(new LoginWidget(b)).withWidget(!0);b=$("#cartPageCartWidgetContainer");b.length&&(new OrderWidget(b)).withWidget();b=$("#cartButton");b.length&&(new OrderWidget($('<div id="#orderWidgetContainer" class="widget">'))).loadWidgetAjaxViaButton(b);b=$("#checkoutPage");b.length&&(new CheckoutWidget(b)).withWidget()});
